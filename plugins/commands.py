...
async def start(client, message):
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            InlineKeyboardButton("🔰 𝘈𝘋𝘋 𝘔𝘌 𝘛𝘖 𝘠𝘖𝘜 𝘎𝘙𝘖𝘜𝘗 🔰", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("⚡ 𝐎𝐖𝐍𝐄𝐑 ⚡", url="https://t.me/NAZZY_FF"), 
            InlineKeyboardButton("♻️ 𝐔𝐏𝐃𝐀𝐓𝐄𝐒 ♻️", url="https://t.me/nazzymovies1")
            ],[      
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton("⚡ᴊᴏɪɴ ɢʀᴏᴜᴘ⚡", url="https://t.me/nazzymovies"),
                                              InlineKeyboardButton("💥ꜱʜᴀʀᴇ💥", url="https://t.me/share/url?url=https://t.me/nazzymovies") ],
                                            [ InlineKeyboardButton("❤️‍🔥 ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ❤️‍🔥", url="https://t.me/nazzymovies1")],
...
async def delete(bot, message):
    ...
    if reply and reply.media:
        msg = await message.reply("𝙋𝙍𝙊𝘾𝙀𝙎𝙎𝙄𝙉𝙂...♻️", quote=True)
    else:
