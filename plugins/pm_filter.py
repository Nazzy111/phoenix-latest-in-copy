...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("sᴇᴀʀᴄʜ ʏᴏᴜʀ sᴇʟғ 👅 ", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton("⚡ 𝐎𝐖𝐍𝐄𝐑 ⚡", url="https://t.me/NAZZY_FF"), 
            InlineKeyboardButton("♻️ 𝐔𝐏𝐃𝐀𝐓𝐄𝐒 ♻️", url="https://t.me/nazzymovies1")
            ],[      
            InlineKeyboardButton("ℹ️ 𝐇𝐄𝐋𝐏 ℹ️", callback_data="help"),
        ...
        buttons = [[
            InlineKeyboardButton('♻️ 𝐁𝐀𝐂𝐊', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ 𝐁𝐔𝐓𝐓𝐎𝐍𝐒', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('♻️ 𝐁𝐀𝐂𝐊', callback_data='manuelfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('♻️ 𝐁𝐀𝐂𝐊', callback_data='help'),
            InlineKeyboardButton('🔰 𝐀𝐃𝐌𝐈𝐍𝐒', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('♻️ 𝐁𝐀𝐂𝐊', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('♻️𝐁𝐀𝐂𝐊', callback_data='help'),
